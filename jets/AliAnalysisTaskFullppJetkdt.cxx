...
ClassImp(AliAnalysisTaskFullppJetkdt)
...
AliAnalysisTaskFullppJetkdt::AliAnalysisTaskFullppJetkdt() : 
...
//________________________________________________________________________
AliAnalysisTaskFullppJetkdt::AliAnalysisTaskFullppJetkdt(const char *name) : 
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::Notify()
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::UserCreateOutputObjects()
{
  // Create histograms
  // Called once
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::BookHistos()
{
  // Book histograms.
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::UserExec(Option_t *) 
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::FindDetJets(const Int_t s, const Int_t a, const Int_t r)
{
  // 
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::FillAODJets(TClonesArray *fJetArray, AliFJWrapper *jetFinder, const Bool_t isTruth)
{
  //
  ...
  for(UInt_t ij=0; ij<jetsIncl.size(); ij++)
      ...
      for(UInt_t ic=0; ic<constituents.size(); ic++)
	{
      ...
      if(GetLeadingZ(ij,jetFinder) > 0.98 )  jet->SetTrigger(AliAnalysisTaskFullppJetkdt::kHighZ);
      if(isTriggering) jet->SetTrigger(AliAnalysisTaskFullppJetkdt::kTrigger);
      if(isHyperTrack) jet->SetTrigger(AliAnalysisTaskFullppJetkdt::kSuspicious);
      if(fIsTPCOnlyVtx) jet->SetTrigger(AliAnalysisTaskFullppJetkdt::kTPCOnlyVtx);
      if(constituents[leadIndex].user_index()>0) jet->SetTrigger(AliAnalysisTaskFullppJetkdt::kLeadCh);
...
//________________________________________________________________________
Int_t AliAnalysisTaskFullppJetkdt::GetParentParton(const Int_t ipart)
{
  // 
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsGoodJet(fastjet::PseudoJet jet, Double_t rad)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::ProcessMC(const Int_t r)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::AnalyzeJets(AliFJWrapper *jetFinder, const Int_t type,  const Int_t r)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::AnalyzeSecondaryContribution(AliFJWrapper *jetFinder, const Int_t r, const Int_t etaCut)
{
  //
  // Analyze secondaries
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::AnalyzeSecondaryContributionViaMatching(AliFJWrapper *jetFinder, const Int_t r, const Int_t type, const Int_t etaCut)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::RunAnalyzeUE(AliFJWrapper *jetFinder, const Int_t type, const Bool_t isMCTruth)
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsGoodJet(AliAODJet *jet, Double_t rad)
{
  // 
...
//________________________________________________________________________
Double_t AliAnalysisTaskFullppJetkdt::GetLeadingZ(const Int_t jetIndex, AliFJWrapper *jetFinder)
{
  //
...
//________________________________________________________________________
Double_t AliAnalysisTaskFullppJetkdt::GetZ(const Double_t trkPx, const Double_t trkPy, const Double_t trkPz, const Double_t jetPx, const Double_t jetPy, const Double_t jetPz) const
{
  // 
...
//________________________________________________________________________
Double_t AliAnalysisTaskFullppJetkdt::GetMeasuredJetPtResolution(const Int_t jetIndex, AliFJWrapper *jetFinder)
{
  //
...
//________________________________________________________________________
Double_t AliAnalysisTaskFullppJetkdt::GetJetMissPtDueToTrackingEfficiency(const Int_t jetIndex, AliFJWrapper *jetFinder, const Int_t radiusIndex)
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsGoodMcPartilce(const AliVParticle* vParticle, const Int_t ipart)
{
  //
...
//________________________________________________________________________
Int_t AliAnalysisTaskFullppJetkdt::FindSpatialMatchedJet(fastjet::PseudoJet jet, AliFJWrapper *jetFinder, Double_t &dEta, Double_t &dPhi, Double_t maxR)
{
  //
...
//________________________________________________________________________
Int_t AliAnalysisTaskFullppJetkdt::FindEnergyMatchedJet(AliFJWrapper *jetFinder1, const Int_t index1, AliFJWrapper *jetFinder2, const Double_t fraction)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::GetESDTrax()
{
  //
  // Get esd tracks.
  //
...
//________________________________________________________________________
//
AliESDtrack *AliAnalysisTaskFullppJetkdt::GetAcceptTrack(AliESDtrack *esdtrack)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::GetESDEMCalClusters()
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsGoodCluster(AliESDCaloCluster *cluster)
{
  //
...
//________________________________________________________________________
Double_t AliAnalysisTaskFullppJetkdt::SubtractClusterEnergy(AliESDCaloCluster *cluster, Double_t &eRes, Double_t &MIPE, Double_t &mcSubE)
{
  //
  // Hadronic correction
  //
...
//________________________________________________________________________
//
Double_t AliAnalysisTaskFullppJetkdt::GetExoticEnergyFraction(AliESDCaloCluster *cluster)
{
  // 
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::GetMCInfo()
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::Terminate(Option_t *) 
{
  //
...
//________________________________________________________________________
//
Int_t AliAnalysisTaskFullppJetkdt::RunOfflineTrigger() 
{
  //
  // Run trigger offline
  //
...
//________________________________________________________________________
//
Double_t AliAnalysisTaskFullppJetkdt::GetOfflineTriggerProbability(AliESDCaloCluster *cluster)
{  
  //
...
//________________________________________________________________________
//
Int_t AliAnalysisTaskFullppJetkdt::GetClusterSuperModule(AliESDCaloCluster *cluster)
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsElectron(AliESDtrack *track, Double_t clsE) const
{
  //
...
//________________________________________________________________________
Double_t AliAnalysisTaskFullppJetkdt::GetTrkEff(Double_t inPt)
{
  // 
...
//________________________________________________________________________
Double_t AliAnalysisTaskFullppJetkdt::GetSmearedTrackPt(AliESDtrack *track)
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::CheckEventTriggerBit()
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::PrintConfig()
{
  //
  // Print configuration
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::CheckExoticEvent()
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::HasPrimaryVertex() const
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsPrimaryVertexOk() const
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsTPCOnlyVtx() const
{
  //
...
//________________________________________________________________________
void AliAnalysisTaskFullppJetkdt::CheckTPCOnlyVtx(const UInt_t trigger)
{
  //
...
//________________________________________________________________________
Bool_t AliAnalysisTaskFullppJetkdt::IsLEDEvent() const
{
  // 
