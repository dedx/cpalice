         ...
         )
{
  ...
  if (useTender) {
    ...
    AliAnalysisTaskSE *clusm = AddTaskEmcalPreparation(runPeriod,AliEMCALRecParam::kClusterizerv2,"pass1"); 
  }
  ...
  gROOT->ProcessLine(".L AliAnalysisTaskEmcalSampleTEST.cxx+g");
