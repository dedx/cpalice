...
ClassImp(AliAnalysisTaskEmcalSampleTEST)

//________________________________________________________________________
AliAnalysisTaskEmcalSampleTEST::AliAnalysisTaskEmcalSampleTEST() : 
  AliAnalysisTaskEmcal("AliAnalysisTaskEmcalSampleTEST", kTRUE),
  fHistTracksPt(0),
  fHistClustersPt(0),
...
//________________________________________________________________________
AliAnalysisTaskEmcalSampleTEST::AliAnalysisTaskEmcalSampleTEST(const char *name) : 
...
//________________________________________________________________________
void AliAnalysisTaskEmcalSampleTEST::UserCreateOutputObjects()
{
  // Create user output.
...
//________________________________________________________________________
Bool_t AliAnalysisTaskEmcalSampleTEST::FillHistograms()
{
  // Fill histograms.
...
//________________________________________________________________________
void AliAnalysisTaskEmcalSampleTEST::CheckClusTrackMatching()
{
...
//________________________________________________________________________
void AliAnalysisTaskEmcalSampleTEST::ExecOnce() {
...
//________________________________________________________________________
Bool_t AliAnalysisTaskEmcalSampleTEST::Run()
{
...
//________________________________________________________________________
void AliAnalysisTaskEmcalSampleTEST::Terminate(Option_t *) 
{
