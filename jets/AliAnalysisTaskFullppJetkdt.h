#ifndef ALIANALYSISTASKFULLPPJETKDT_H
#define ALIANALYSISTASKFULLPPJETKDT_H
...
#endif
class AliAnalysisTaskFullppJetkdt : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskFullppJetkdt();
  AliAnalysisTaskFullppJetkdt(const char *name);
  virtual ~AliAnalysisTaskFullppJetkdt();
...
protected:
 ...
 private:
  ...
  AliAnalysisTaskFullppJetkdt(const AliAnalysisTaskFullppJetkdt&);            // not implemented
  AliAnalysisTaskFullppJetkdt &operator=(const AliAnalysisTaskFullppJetkdt&); // not implemented

  ClassDef(AliAnalysisTaskFullppJetkdt, 3);
};
